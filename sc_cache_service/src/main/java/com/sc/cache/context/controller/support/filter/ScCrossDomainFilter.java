package com.sc.cache.context.controller.support.filter;
...
public class ScCrossDomainFilter implements Filter {

    /**
     * 注入日志系统
     */
    private static final Logger logger = LoggerFactory.getLogger(ScCrossDomainFilter.class);
